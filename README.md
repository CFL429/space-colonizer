# Space Colonizer — your agent threads, as a colony
...
A **harness** is whatever actually runs your threads. Space Colonizer reads each one's local
...
Space Colonizer is one shape this idea can take. `.claude/skills/agent-session-world/` is a skill for
